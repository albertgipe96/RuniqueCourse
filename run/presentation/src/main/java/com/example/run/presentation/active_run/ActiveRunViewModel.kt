...
class ActiveRunViewModel(
    ...
    private val hasLocationPermission = MutableStateFlow(false) // We want it to start tracking user position when it becomes true

    private val isTracking = combine(shouldTrack, hasLocationPermission) { shouldTrack, hasLocationPermission ->
